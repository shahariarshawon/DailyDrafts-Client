    ...
    <div className="navbar bg-white px-4 py-2 ">
      ...
      <div className="navbar-start">
        ...
        <div className="dropdown">
          ...
          >
            ...
            <li><Link to="/featured">Featured Blogs</Link></li>
            <li><Link to="/wishlist">Wishlist</Link></li>
          </ul>
        </div>

        {/* Logo (Always visible, better spacing) */}
        <Link to="/" className= " hidden md:inline-block text-xl md:text-2xl font-bold ml-2 md:ml-4">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 font-medium text-gray-600 space-x-1">
          ...
          <li><Link to="/add-blog" className="hover:text-indigo-600 transition">Add Blog</Link></li>
          <li><Link to="/all-blogs" className="hover:text-indigo-600 transition">All Blogs</Link></li>
          <li><Link to="/featured" className="hover:text-indigo-600 transition">Featured Blogs</Link></li>
          <li><Link to="/wishlist" className="hover:text-indigo-600 transition">Wishlist</Link></li>
        </ul>
      </div>
      ...
      <div className="navbar-end space-x-2 md:space-x-3">
        ...
        <Link
          to="/login"
          className="relative inline-block px-4 md:px-5 py-1.5 md:py-2 font-medium group border-2 border-indigo-600 text-indigo-600 rounded-md overflow-hidden text-sm md:text-base"
        >
          ...
          <span className="relative z-10 group-hover:text-white transition">Login</span>
        </Link>
        ...
        >
          ...
          <span className="relative z-10 group-hover:text-white transition">Register</span>
        </Link>
      </div>
    </div>
  );
